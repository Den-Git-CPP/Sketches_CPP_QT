...
class convertcoordinat : public QWidget {
  ...
  private:
    ...
    void CalculateDecCoordinates (const QString& Grad_Lat, const QString& Min_Lat, const QString& Sec_Lat, const QString& Grad_Long, const QString& Min_Long, const QString& Sec_Long);
